    ...
    <section className="w-full px-8 md:px-16 py-20">
      <div className="max-w-[1200px] mx-auto text-center">
        {/* Exact from Figma:
            ...
            Gradient on "best"
        */}
        <h2 className="font-serif text-[48px] md:text-[80px] lg:text-[114px] font-normal text-white mb-12 leading-tight">
          Trusted by the{" "}
        ...
        <div className="flex flex-wrap items-center justify-center gap-8 md:gap-16">
          {[
            ...
            <span
              key={partner.name}
              className="font-sans text-[16px] md:text-[24px] font-medium"
